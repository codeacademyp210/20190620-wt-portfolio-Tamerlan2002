...
namespace resume.Areas.Admin.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,SkillName,SkillPercent")] Skills skills)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,SkillName,SkillPercent")] Skills skills)
        {
            if (ModelState.IsValid)
            {
